...
namespace BScSciencePlanet
{
    public partial class Form1 : Form
    {
        ...
        private void btnsave_Click(object sender, EventArgs e)
        {
            if (Validation())
            {
                if (student.Create(txtfirstname.Text, txtlastname.Text, txtbirth.Text,txtgrade.Text, txtfathername.Text, txtfatherwork.Text, txtfatherphone.Text,txtmothername.Text, txtmotherwork.Text, txtmotherphone.Text, txtschoolname.Text, txtresult.Text, txtaddress.Text, txtclass.Text))
                {
