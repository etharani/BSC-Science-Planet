    ...
    public partial class Update : Form
    {
        ...
        { 
            ...
            if (Validation())
            {
                ...
                if (stu.Update(txtfirstname.Text, txtlastname.Text, txtbirth.Text, txtgrade.Text, txtfathername.Text, txtfatherwork.Text, txtfatherphone.Text, txtmothername.Text, txtmotherwork.Text, txtmotherphone.Text, txtschoolname.Text, txtresult.Text, txtaddress.Text, txtclass.Text, this.id))
                {
